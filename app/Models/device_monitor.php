...
class device_monitor extends Model
{
    use HasFactory;
    ...
    /**
     * Get the operator that owns the device monitor.
     */
    ...
    /**
     * Get the group admin for the device monitor.
     */
    public function group_admin()
    {
        return $this->belongsTo(operator::class, 'gid', 'id');
    }
}
