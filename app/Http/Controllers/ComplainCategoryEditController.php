...
class ComplainCategoryEditController extends Controller
{
    ...
    public function store(Request $request, customer_complain $customer_complain)
    {
        ...
        $complain_ledger->topic = "category";
        $complain_ledger->fcid = $customer_complain->category_id;
        $complain_ledger->tcid = $request->category_id;
        ...
        return redirect()->route('customer_complains.show', ['customer_complain' => $customer_complain->id])->with('success', 'Category Updated!');
    }
}
