...
class AccountsReceivableCashOutController extends Controller
{
    /**
    ...
    public function create(Request $request, account $account)
    {
        ...
        switch ($role) {
            case 'super_admin':
                return view('admins.super_admin.accounts-receivable-cash-out', [
                    'account' => $account,
                ]);
                break;

            case 'group_admin':
                return view('admins.group_admin.accounts-receivable-cash-out', [
                    'account' => $account,
                ]);
                break;

            case 'operator':
                return view('admins.operator.accounts-receivable-cash-out', [
                    'account' => $account,
                ]);
                break;

            case 'sub_operator':
                return view('admins.sub_operator.accounts-receivable-cash-out', [
                    'account' => $account,
                ]);
                break;
        }
