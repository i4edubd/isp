...
class HotspotPackageChangeController extends Controller
{
    /**
    ...
    public function edit(Request $request, customer $customer)
    {
        ...
        switch ($operator->role) {
            case 'group_admin':
                return view('admins.group_admin.hotspot-package-change', [
                    'customer' => $customer,
                    'packages' => $packages,
            ...
            case 'operator':
                return view('admins.operator.hotspot-package-change', [
                    'customer' => $customer,
                    'packages' => $packages,
                    'active_package' => $active_package,
                ]);
            ...
            case 'sub_operator':
                return view('admins.sub_operator.hotspot-package-change', [
                    'customer' => $customer,
                    'packages' => $packages,
                    'active_package' => $active_package,
                ]);
            ...
            case 'manager':
                return view('admins.manager.hotspot-package-change', [
                    'customer' => $customer,
                    'packages' => $packages,
                    'active_package' => $active_package,
                ]);
    ...
    public function update(Request $request, customer $customer)
    {
        ...
        $customer_payment->purpose = PaymentPurpose::PACKAGE_CHANGE->value;
