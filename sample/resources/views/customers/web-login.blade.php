...
<body class="hold-transition layout-top-nav">
    ...
    <div class="wrapper">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse order-3" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="{{ config('consumer.about_link') }}" class="nav-link"> <i class="fas fa-home"></i>
                                About</a>
                        </li>

                        <li class="nav-item">
                            <a href="{{ route('login') }}" class="nav-link"><i class="fas fa-user-cog"></i> Admin
                                Login</a>
                        </li>

                        <li class="nav-item">
                            <a href="{{ route('card.login') }}" class="nav-link"><i class="fas fa-credit-card"></i> Card
        ...
        <footer class="main-footer">
            ...
            | <a href="{{ route('refund-policy') }}"> Refund & Delivery Policy </a>
