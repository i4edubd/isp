...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form id="quickForm" method="POST"
            action="{{ route('customers.custom_prices.store', ['customer' => $customer->id]) }}">
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="package_name" value="{{ $package->name }}" disabled>
                </div>
                <!--/Package Name-->
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="regular_price"
                        value="{{ $package->price }} {{ config('consumer.currency') }}" disabled>
                </div>
                <!--/Regular Price-->
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input name="special_price" type="text"
                            ...
                            value="{{ old('special_price') }}" required>
