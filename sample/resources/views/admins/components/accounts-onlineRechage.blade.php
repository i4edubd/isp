...
<h3>Online Recharge <i class="fas fa-money-check-edit-alt"></i></h3>
@endsection
...
<ol class="breadcrumb text-danger float-sm-right">
    ...
    <li class="breadcrumb-item active">Online Recharge</li>
</ol>
@endsection
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <form id="quickForm" method="POST"
                    action="{{ route('accounts.OnlineRechage.store', ['account' => $account ]) }}">
                    ...
                    <div class="card-body">
                        ...
                        <!--amount-->
                        <div class="form-group">
                            <label for="amount"><span class="text-danger">*</span>Amount to recharge</label>
