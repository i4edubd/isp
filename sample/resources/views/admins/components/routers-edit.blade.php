...
@section('content')
    <div class="card">
        ...
        <form id="quickForm" method="POST" action="{{ route('routers.update', ['router' => $router->id]) }}"
            autocomplete="off">
            @csrf
            @method('PUT')
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input name="api_username" type="text"
                        ...
                        value="{{ $router->api_username }}" autocomplete="new-password" required>
                    @error('api_username')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <input name="api_password" type="password"
                        ...
                        value="{{ $router->api_password }}" autocomplete="new-password" required>
                    @error('api_password')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
