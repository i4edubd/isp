...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="col-sm-6">
            ...
            <form method="POST"
                action="{{ route('customer_payments.edit.store', ['customer_payment' => $customer_payment->id]) }}">
                ...
                <div class="form-group">
                    ...
                    <input name="amount_paid" type="text" class="form-control" id="amount_paid"
                        value="{{ $customer_payment->amount_paid }}" required>
