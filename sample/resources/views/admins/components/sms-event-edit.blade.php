    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('event_sms.update', ['event_sms' => $event_sms->id]) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="default_sms" rows="3" disabled>{{ $event_sms->getAttributeValue($default_attribute) ?
                        $event_sms->getAttributeValue($default_attribute) : $event_sms->default_sms }}</textarea>
            </div>
            {{-- default_sms --}}
            ...
            <div class="form-group">
                ...
                <textarea name="operator_sms" class="form-control" id="operator_sms"
                    rows="3">{{ $event_sms->operator_sms }}</textarea>
            </div>
            {{-- operator_sms --}}
