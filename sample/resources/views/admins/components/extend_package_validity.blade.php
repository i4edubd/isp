...
<div class="card">
    ...
    <div class="card-header">
        <h3 class="card-title font-weight-bold">
            Operator/Reseller: {{ $operator->name }} :: Invoice (Estimated) for Recharge
        </h3>
    </div>
    ...
    <div class="card-footer">
        ...
        <div class="callout callout-warning">
            The balance of the operator's account ({{ $account_balance }}) is less than the operator's total cost
            ({{ $total_operators_amount }}). Some customer accounts will not be recharged.
        </div>
        @endif
        ...
        <div class="row">
            ...
            <form method="POST"
                action="{{ route('operators.extend_package_validity.store', ['operator' => $operator]) }}">
