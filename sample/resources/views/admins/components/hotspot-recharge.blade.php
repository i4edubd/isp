        ...
        <div class="col-sm-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('hotspot-recharge.update', ['customer' => $customer->id]) }}">
...
@section('pageJs')
    <script>
        function showRuntimeInvoice(customer, package) {
            $("#btn-submit").attr("disabled", true);
            $("#runtime_invoice").html('<div class="overlay"><i class="fas fa-2x fa-sync-alt fa-spin"></i></div>');
            let url = "/admin/hotspot-recharge-runtime-invoice/" + customer + "/" + package;
