...
<div class="card">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <form
                        action="{{ route('bkash_tokenized.subscription_payment.cancel_agreement', ['subscription_payment' => $subscription_payment->id]) }}"
                        method="POST">
                        @csrf
    ...
    <div class="card-body text-center">
        ...
        <p class="card-text">User Count: {{ $subscription_payment->user_count }}</p>
        ...
        <form method="GET"
            action="{{ route('bkash_tokenized.subscription_payment.create_payment', ['subscription_payment' => $subscription_payment->id]) }}">
