        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <form method="POST" action="{{ route('temp_customers.store') }}">
                        ...
                        @else
                            <div class="form-group">
                                ...
                                <input name="mobile" type="text"
                                    ...
                                    value="{{ old('mobile') }}" onblur="checkDuplicateMobile(this.value)" required>
                                @error('mobile')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group">
                            ...
                            <input name="nid" type="text" class="form-control @error('nid') is-invalid @enderror"
                                id="nid" value="{{ old('nid') }}" autocomplete="nid" @required(isMandatoryCustomerAttribute('nid', Auth::user()))>
                            @error('nid')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="date_of_birth" name="date_of_birth"
                                ...
                                @required(isMandatoryCustomerAttribute('date_of_birth', Auth::user()))>
                        ...
                        <div class="form-group">
                            ...
                            <input name="email" type="email" class="form-control @error('email') is-invalid @enderror"
                                id="email" value="{{ old('email') }}" autocomplete="email" @required(isMandatoryCustomerAttribute('email', Auth::user()))>
                            @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
