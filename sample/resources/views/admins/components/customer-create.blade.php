                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <input name="house_no" type="text"
                                ...
                                value="{{ old('house_no') }}" @required(isMandatoryCustomerAttribute('house_no', Auth::user()))>
                            @error('house_no')
                        ...
                        <div class="form-group">
                            ...
                            <input name="road_no" type="text" class="form-control @error('road_no') is-invalid @enderror"
                                id="road_no" value="{{ old('road_no') }}" @required(isMandatoryCustomerAttribute('road_no', Auth::user()))>
                            @error('road_no')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <input name="thana" type="text" class="form-control @error('thana') is-invalid @enderror"
                                id="thana" value="{{ old('thana') }}" @required(isMandatoryCustomerAttribute('thana', Auth::user()))>
                            @error('thana')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <input name="district" type="text"
                                ...
                                value="{{ old('district') }}" @required(isMandatoryCustomerAttribute('district', Auth::user()))>
                            @error('district')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
