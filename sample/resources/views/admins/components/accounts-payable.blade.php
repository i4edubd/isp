...
<dl class="row">
    <dt class="px-1">Account Provider (Will pay money):</dt>
        ...
        <table id="data_table" class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="#" onclick="showAccountOwnerDetails('{{ $account->owner->id }}')">
                            {{ $account->owner->name }} ( {{ $account->owner->company }} )
                        </a>
                    </td>
                    ...
                    <td>
                        ...
                        {{-- Send Money --}}
                        @can('sendMoney', $account)
                        <a class="btn btn-outline-info btn-sm mb-2"
                            href="{{ route('pending_transactions.create', ['account' => $account]) }}">
                        ...
                        {{-- onlinePayment --}}
                        @can('onlinePayment', $account)
                        <a class="btn btn-outline-info btn-sm mb-2"
                            href="{{ route('accounts.OnlinePayment.create', ['account' => $account]) }}">
                            <i class="far fa-paper-plane"></i>
                            Pay Now
                        </a>
                        @endcan
                        ...
                        <a class="btn btn-outline-info btn-sm mb-2"
                            href="{{ route('accounts.exchange.create', ['account' => $account]) }}">
