                    ...
                    <form id="quickForm" method="POST"
                        ...
                        <div class="form-group">
                            <label for="company_in_native_lang"><span class="text-danger">*</span>
                                Company Name in {{ config('languages.' . getLangCode($operator->id)) }}
                            </label>
                            <input name="company_in_native_lang" type="text"
                                class="form-control @error('company_in_native_lang') is-invalid @enderror"
                                id="company_in_native_lang" value="{{ $operator->company_in_native_lang }}"
                        ...
                        <div class="form-group">
                            ...
                            <input name="email" type="email" class="form-control @error('email') is-invalid @enderror"
                                id="email" value="{{ $operator->email }}" autocomplete="off" required>
                            @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
