        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <form id="quickForm" method="POST" action="{{ route('affiliate-leads.store') }}" autocomplete="off"
                        ...
                        <div class="form-group">
                            ...
                            <input name="company" type="text" class="form-control @error('company') is-invalid @enderror"
                                id="company" value="{{ old('company') }}" autocomplete="new-password" required>
                            @error('company')
