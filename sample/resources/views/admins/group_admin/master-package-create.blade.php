                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input name="rate_limit" type="number"
                            ...
                            aria-describedby="rateLimitHelp" value="0" required>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control" id="speed_controller" name="speed_controller"
                            ...
                            <option selected>
                                {{ $temp_package->connection_type == 'PPPoE' ? 'Router' : 'Radius_Server' }}
                            </option>
                            <option>
                                {{ $temp_package->connection_type == 'PPPoE' ? 'Radius_Server' : 'Router' }}
                            </option>
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input name="volume_limit" type="number"
                            ...
                            aria-describedby="mbLimitHelp" value="0" required>
                        <div class="input-group-append">
                            <span class="input-group-text">
