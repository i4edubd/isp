...
return [
    ...
    'webhook_handler' => App\Http\Controllers\TelegramWebhookHandler::class,
    ...
    'security' => [
         ...
         */
        'allow_messages_from_unknown_chats' => env('ALLOW_MESSAGES_FROM_UNKNOWN_CHATS', false),
     ...
     */
    'models' => [
        'bot' => App\Models\telegraph_bot::class,
        'chat' => App\Models\telegraph_chat::class,
    ],
