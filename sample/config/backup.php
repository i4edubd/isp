...
return [
    ...
    'backup' => [
        ...
        'source' => [
            ...
            'files' => [
                 ...
                 */
                'include' => [storage_path('app/payment-gateways')],
        ...
        'destination' => [
             ...
             */
            'filename_prefix' => config('app.name'),

            /*
             * The disk names on which the backups will be stored.
             */
            'disks' => [env('BACKUP_DISK')],
        ],
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             */
            'keep_weekly_backups_for_weeks' => 30,
