...
class card_distributor_payments extends Model
{
    use HasFactory;
    ...
    /**
     * Get the distributor that owns the payments.
     */
    public function distributor()
    {
        return $this->belongsTo(card_distributor::class, 'card_distributor_id', 'id');
    }
}
