...
*/
    ...
    public $mkt_menus = [
        'interface'  => 'Interface',
        'interface_sstp_client' => 'interface sstp-client',
        'vlan'          => 'VLAN',
    ...
    public $mkt_menu_base_command = [
        ...
        'user' => '/user/',
        'ppp_active' => '/ppp/active/',
        'layer7_protocol' => '/ip/firewall/layer7-protocol/',
    ...
    public $mkt_menu_property_list = [
        ...
        "interface_sstp_client" => ['name', 'profile', 'connect-to', 'user', 'password', 'comment'],
        "vlan"       => ['name', 'interface', 'vlan-id', 'mac-address', 'comment'],
        'ip_address' => ['address', 'interface', 'network', 'comment'],
        'ip_route' => ['dst-address', 'gateway', 'comment'],
        ...
        'hotspot_user' => ['name', 'mac-address', 'password', 'profile', 'bytes-in', 'bytes-out', 'comment', 'disabled'],
        ...
        'ip_hotspot' => ['name', 'profile', 'interface', 'address-pool', 'idle-timeout', 'keepalive-timeout', 'login-timeout'],
        ...
        'layer7_protocol' => ['name', 'regexp', 'comment'],
        'firewall_address_list' => ['list', 'address'],
        'tool_netwatch' => ['host', 'timeout', 'interval', 'up-script', 'down-script', 'comment']
    ];
