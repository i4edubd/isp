...
class YearlyCashInsRecord extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'yearly_cash_ins_record';
     ...
     * @var string
     */
    protected $description = 'Yearly Cash Ins Record';
    ...
    public function handle()
    {
        ...
        while ($account = $accounts->shift()) {
            ...
            $amount = cash_in::where($where)->sum('amount');

            yearly_cash_in::updateOrCreate(
