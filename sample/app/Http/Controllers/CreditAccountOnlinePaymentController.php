...
class CreditAccountOnlinePaymentController extends Controller
{
    /**
    ...
    {
        $this->authorize('onlinePayment', $account);

        $payment_gateways = payment_gateway::where('operator_id', $account->account_owner)->get();
        ...
        switch ($role) {
            case 'operator':
                return view('admins.operator.accounts-onlinePayment', [
                    'account' => $account,
            ...
            case 'sub_operator':
                return view('admins.sub_operator.accounts-onlinePayment', [
                    'account' => $account,
                    'payment_gateways' => $payment_gateways,
                ]);
                break;
    ...
    public function store(Request $request, account $account)
    {
        ...
        $operators_online_payment->payment_purpose = 'cash_out';
