...
class RechargeCardDownloadController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        switch ($operator->role) {
            ...
            case 'operator':
                return view('admins.operator.recharge-card-download-create', [
                    'distributors' => $distributors,
                    'packages' => $packages,
                ]);
                break;
            ...
            case 'sub_operator':
                return view('admins.sub_operator.recharge-card-download-create', [
                    'distributors' => $distributors,
                    'packages' => $packages,
                ]);
                break;
    ...
    public function store(Request $request)
    {
        ...
        if ($request->file_format == 'PDF') {
            ...
            foreach ($cards as $card) {
                ...
                $mpdf->SetWatermarkText($card->distributor->name);
